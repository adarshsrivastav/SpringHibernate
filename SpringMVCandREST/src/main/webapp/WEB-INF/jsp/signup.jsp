...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<div>
				<h1>Welcome Customer Enrollment Signup</h1>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" name="emailAddress"
											...
											value="${it.customer.emailAddress}" />
									</div>
								</div>
